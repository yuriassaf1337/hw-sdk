...
namespace sdk
{
	...
	public:
		...
		virtual void get_shadow_render_bounds( math::vec3& mins, math::vec3& maxs, int /*shadow_type_t*/ shadow_type )                       = 0;
		virtual bool should_receive_projected_textures( int flags )                                                                          = 0;
		virtual bool get_shadow_cast_distance( float* p_dist, int /*shadow_type_t*/ shadow_type ) const                                      = 0;
		virtual bool get_shadow_cast_direction( math::vec3* p_direction, int /*shadow_type_t*/ shadow_type ) const                           = 0;
		...
		virtual int /*shadow_type_t*/ shadow_cast_type( )                                                                                    = 0;
