...
void menu::window::draw( int& window_x, int& window_y, int& size_x, int& size_y )
{
	...
	auto font_size = g_render.render_text_size( _( "merdahook" ), menu_font );

	g_render.render_text( ( window_x + 3 ) + ( size_x - 6 ) / 2, window_y + 5,
	                      font_alignment::AL_HORIZONTAL_CENTER | font_alignment::AL_VERTICAL_CENTER, font_flags::FLAG_NONE, _( "merdahook" ),
